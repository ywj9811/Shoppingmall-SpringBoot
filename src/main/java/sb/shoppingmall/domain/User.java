...
public class User {
    ...
    private int user_status, user_total, user_class, user_gender, user_birth;
    private String user_id, user_pw, user_name, user_tel, user_logdate;
    private String user_email, user_addr, user_daddr, user_regdate, user_nick;
    ...
    , int user_birth, String user_nick){
